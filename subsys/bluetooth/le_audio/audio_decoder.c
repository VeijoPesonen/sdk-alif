...
#define LC3_FRAME_DURATION FRAME_DURATION_10_MS
#elif CONFIG_ALIF_BLE_AUDIO_FRAME_DURATION_7_5MS
#define LC3_FRAME_DURATION FRAME_DURATION_7_5_MS
#endif
					   ...
					   struct audio_queue *audio_queue)
{
	...
	int ret = lc3_api_configure(&dec->lc3_cfg, (int32_t)sampling_frequency, LC3_FRAME_DURATION);
